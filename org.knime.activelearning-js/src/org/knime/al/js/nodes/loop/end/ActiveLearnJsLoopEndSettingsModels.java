 ...
 */
public final class ActiveLearnJsLoopEndSettingsModels {

    private ActiveLearnJsLoopEndSettingsModels() {
        // NB: disallow instantiation.
    }

    /**
     * @return Model to store the the name of the representative column.
     */
    protected static SettingsModelString createRepColumnModel() {
